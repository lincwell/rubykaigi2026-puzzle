...
const en: Translations = {
  ...
  quizSubtitle: 'Test Your Ruby Proficiency',
  quizDescHtml: `Using <code class="bg-gray-100 px-1 rounded text-sm">"Lincwell"</code> as the starting point, construct a method chain that returns <span class="underline decoration-2 underline-offset-2">the largest possible integer</span>.`,
  labelPatient: 'Patient',
  labelMethods: 'Methods',
  labelDirections: 'Directions',
  labelDosage: 'Dosage',
  directionsText: 'Administer the above methods as a chained sequence',
  dosageText: 'Administer each once',
  labelPrescription: 'Prescription',
  btnClear: 'Clear',
  labelOrder: 'Order of administration',
